    ...
    <div className="min-h-screen islamic-bg">
      <div className="container mx-auto px-4 py-8 lg:py-0">
        <div className="grid lg:grid-cols-2 min-h-screen items-center gap-8 lg:gap-0">
          ...
          <div className="hidden lg:flex items-center justify-center relative order-1 lg:order-1">
            <div className="relative w-full max-w-lg xl:max-w-xl 2xl:max-w-2xl">
              ...
              <div className="absolute top-8 lg:top-12 xl:top-16 left-4 lg:left-8 floating-cloud">
                <svg className="w-16 h-8 lg:w-20 lg:h-10 xl:w-24 xl:h-12" viewBox="0 0 120 60">
              ...
              <div className="absolute bottom-16 lg:bottom-20 xl:bottom-24 right-4 lg:right-8 floating-cloud">
                <svg className="w-18 h-9 lg:w-22 lg:h-11 xl:w-26 xl:h-13" viewBox="0 0 130 65">
          ...
          <div className="flex items-center justify-center order-2 lg:order-2 relative">
            <div className="absolute top-0 right-4 sm:right-8 lg:hidden">
              <Image
                ...
                width={80}
                height={88}
                className="drop-shadow-md opacity-20 sm:opacity-25 w-16 h-auto sm:w-20"
              />
            </div>
            ...
            <Card className="w-full max-w-sm sm:max-w-md lg:max-w-lg xl:max-w-xl mx-4 p-6 sm:p-8 lg:p-10 text-center shadow-2xl bg-white/95 backdrop-blur-sm border-0 rounded-2xl lg:rounded-3xl">
              <div className="mb-6 lg:mb-8">
                <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-emerald-800 mb-2 lg:mb-3 text-balance leading-tight">
                  Islamic Knowledge
                </h1>
                <h2 className="text-lg sm:text-xl lg:text-2xl xl:text-3xl font-semibold text-emerald-700 mb-3 lg:mb-4 text-balance">
                  Quiz Application
                </h2>
                <p className="text-sm sm:text-base lg:text-lg text-emerald-600 text-balance leading-relaxed px-2 lg:px-4">
              ...
              <div className="space-y-2 lg:space-y-3 mb-6 lg:mb-8">
                ...
                <div className="flex items-center justify-center gap-2 lg:gap-3 text-emerald-700">
                  <div className="w-2 h-2 lg:w-3 lg:h-3 bg-yellow-500 rounded-full flex-shrink-0"></div>
              ...
              <Button
                onClick={onStart}
                className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-3 sm:py-4 lg:py-5 px-6 sm:px-8 rounded-xl lg:rounded-2xl transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-lg text-base sm:text-lg lg:text-xl touch-manipulation"
              >
                Begin Your Journey
              </Button>
            </Card>
